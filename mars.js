...
mars.on("message", msg => {
  ...
  if (msg.content.includes("http")) {
    ...
    msg.delete();
    msg.reply("```You cant send Partner .``` <a:emoji_8:797912425717301318>");
  }
});
////////
...
mars.on("message", msg => {
  ...
  if (msg.content.includes("@everyone")) {
    ...
    if (!msg.channel.guild) return;
    msg.delete();
    msg.reply("```You cant send everyone .``` <a:emoji_8:797912425717301318>");
  }
});
...
mars.on("message", msg => {
  ...
  if (msg.content.includes("@here")) {
    ...
    if (!msg.channel.guild) return;
    msg.delete();
    msg.reply("```You cant send here .``` <a:emoji_8:797912425717301318>");
  }
});
////////////////// code security
const rast = "";
